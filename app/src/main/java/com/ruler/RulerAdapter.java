...
import com.ruler.bean.ScaleMode;
import com.ruler.bean.TimeSlot;
import com.ruler.utils.CUtils;
...
//    private LinearLayout.LayoutParams leftParams, rightParams;
    ...
    public RulerAdapter(Context context) {
        ...
        TranslateAnimation translateAnimationRight = new TranslateAnimation(0, 0, 0, -CUtils.dip2px(3), 0, 0, 0, 0);
        ...
        AlphaAnimation alphaAnimationLeft = new AlphaAnimation(0f, 1f) /*1f, 0f*/;
        TranslateAnimation translateAnimationLeft = new TranslateAnimation(0, 0, 0, CUtils.dip2px(3),  0, 0, 0, 0);
    ...
    public void onBindViewHolder(RulerViewHolder holder, int position) {
        ...
        holder.parentView.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, RulerView.viewHeight));
