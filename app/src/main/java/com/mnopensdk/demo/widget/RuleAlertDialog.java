...
public class RuleAlertDialog {
    ...
    public RuleAlertDialog dismiss() {
    ...
    public RuleAlertDialog setOkButton(CharSequence text, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
    ...
    public RuleAlertDialog setCancelButton(CharSequence text, final OnClickListener listener) {
        showNegBtn = true;
        if (text == null) {
            btn_neg.setVisibility(View.GONE);
            return this;
    ...
    public RuleAlertDialog setCancelBtnColor(int res) {
