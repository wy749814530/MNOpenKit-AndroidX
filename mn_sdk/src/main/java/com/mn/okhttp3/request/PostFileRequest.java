package com.mn.okhttp3.request;


import com.mn.okhttp3.OkHttpUtils;
import com.mn.okhttp3.callback.Callback;
import com.mn.okhttp3.utils.Exceptions;
...
{
    private static MediaType MEDIA_TYPE_STREAM = MediaType.parse("application/octet-stream;application/json;");
